...
class MoveBaseStraightAction(object):
    ...
    def __init__(self, name):
        ...
        # Where to publish the Twist command.
        self.CMD_VEL_TOPIC = rospy.get_param('cmd_vel_topic', 'base_controller/command')
        # ----------------------------------------------------------------------
        ...
        self.scan = rospy.get_param('laser_scan_topic', '/scan')
        rospy.Subscriber(self.scan, LaserScan, self.laser_cb)
